...
static iree_status_t iree_hal_metal_executable_flatbuffer_read_size(
    iree_const_byte_span_t executable_data, iree_const_byte_span_t* out_flatbuffer_data) {
...
iree_status_t iree_hal_metal_executable_create(
  ...
  *out_executable = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_metal_executable_flatbuffer_read_size(executable_params->executable_data,
